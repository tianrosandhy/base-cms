<div class="card card-body">
	...
	<div class="alert alert-info">You can <a href="#datastructure_basic" data-value="datastructure_basic" class="doc-ajax-load">check the DataStructure documentation here</a>.</div>
