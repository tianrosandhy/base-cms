...
<link class="main-stylesheet" href="{!! admin_asset('css/override.css') !!}" rel="stylesheet" type="text/css" />
<link class="main-stylesheet" href="{!! admin_asset('css/additional.css?v=1.0.0') !!}" rel="stylesheet" type="text/css" />
