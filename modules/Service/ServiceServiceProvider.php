...
{
	protected $namespace = 'Module\Service\Http\Controllers';
    ...
    $this->loadHelpers(__DIR__);
		...
		$this->loadViewsFrom(realpath(__DIR__."/Views"), 'service');
	    ...
	    $this->registerFacadeAlias('ServiceInstance', \Module\Service\Facades\ServiceFacade::class);
	}
