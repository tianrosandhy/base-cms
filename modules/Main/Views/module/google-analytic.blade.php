...
<?php $google_analytics_client_id = setting("admin.google_analytics_client_id"); ?>
<div class="analytics-container">
	@if (isset($google_analytics_client_id) && !empty($google_analytics_client_id))
	    <div id="embed-api-auth-container"></div>
	@else
	    <p style="border-radius:4px; padding:20px; background:#fff; margin:0; color:#999; text-align:center;">
	        Please get your Google Client ID first
	...
	@if (isset($google_analytics_client_id) && !empty($google_analytics_client_id))
	<div class="card card-body" id="analytics-dashboard">
	    <header class="Dashboard-header">
			<div class="Titles">
				<h4 class="Titles-main" id="view-name">Select View</h4>
			</div>
        ...
        <script>
            ...
            gapi.analytics.ready(function () {
                ...
                var viewSelector = new gapi.analytics.ext.ViewSelector2({
                    ...
                    propertyId: '{{ setting("site.google_analytics_tracking_id")  }}'
                })
                        .execute();
